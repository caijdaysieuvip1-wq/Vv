...
// gõ chức năng đường ống dường như không hoạt động để sử dụng khi được áp dụng một phần?
...
(function() {
    var animation = {
      ...
      get period() {
        ...
        // Nếu tất cả về 0 và giây trở về số 1 thì chúng ta chuyển qua trang bắn pháo hoa luôn.
          // Mình để seconds = 1 vì khi chuyển trang và nạp pháo hoa là vừa rồi.
